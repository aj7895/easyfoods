...
const Highlight = () => {
  return (
    <div className="2xl:container 2xl:mx-auto my-3 md:py-3 py-9">
      <div className="shadow rounded-md grid lg:grid-cols-4 md:grid-cols-2 grid-cols-1 lg:gap-8 md:gap-12 gap-14 lg:px-20 lg:py-4 py-10 md:px-12 px-4">
        {/* Delivery grid Card */}
        <div>
          <svg
            width="32"
